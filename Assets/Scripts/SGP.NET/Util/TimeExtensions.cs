...
namespace SGPdotNET.Util
{
    ...
    public static class TimeExtensions
    {
        ...
        public static double ToJulian2(this DateTime dt)
        {
        ...
        public static double ToGreenwichSiderealTime2(this DateTime dt)
        {
            // t = Julian centuries from 2000 Jan. 1 12h UT1
            var t = (dt.ToJulian2() - 2451545.0) / 36525.0;
        ...
        {
            return MathUtil.WrapTwoPi(dt.ToGreenwichSiderealTime2() + longitude.Radians);
        }
